...
import login from "../../../assets/Tablet login-amico.png";
...
const Login = () => {
  /* ================== auth ======================  */
  const [signInWithEmailAndPassword, user, loadingerror] =
    ...
    <div>
      ...
      <div className="p-5">
        <div className="md:flex gap-5 justify-around items-center w-full md:h-[80vh] ">
          <div>
            <img
              className=" md:w-[196px] lg:w-[496px] mx-auto"
              src={login}
              alt="Login images"
            />
          </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="form-control w-full max-w-xs">
                    ...
                    <label className="label mt-[-20px]">
                      ...
                      <span className="label-text-alt text-orange-400 font-medium">
