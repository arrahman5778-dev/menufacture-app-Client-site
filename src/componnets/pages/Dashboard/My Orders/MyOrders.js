      ...
      <div>
        <div className="overflow-x-auto shadow-2xl">
          <table className="table w-full text-center">
            ...
            <tbody>
              {UserOrder.map((myOrder, index) => (
                <tr key={myOrder._id}>
                  <th>{index + 1}</th>
                  <th>
                    <img
                      className="w-24 rounded-full "
                      src={myOrder.OrderImages}
                      alt="Images"
                    />
                  </th>
                  ...
                  {!myOrder.paid && (
                    <th>
                      <button
                        onClick={() => Navigate(`payment/${myOrder._id}`)}
                  ...
                  <th>
                    {myOrder?.paid ? (
                      <th>{myOrder.user.id.slice(0, 6)}..</th>
                    ) : (
                      <button onClick={() => MyOrderDelete(myOrder?._id)}>
