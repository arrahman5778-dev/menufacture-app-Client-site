      ...
      <div className="w-full flex items-center justify-center my-12">
        <div className=" top-40 bg-white shadow-2xl rounded-3xl py-12 lg:px-28 px-8 ">
          <p className="md:text-3xl text-xl font-bold leading-7 text-center">
            Contact <span className="text-orange-500  ">Pages</span>
          </p>
          ...
          <div>
            <div className="w-full flex flex-col mt-8">
              ...
              <textarea
                ...
                type="name"
                className="h-36 text-base leading-none text-gray-900 p-3  focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none"
                defaultValue={""}
              />
            </div>
          </div>
