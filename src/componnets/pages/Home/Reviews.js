  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto my-16 px-8 mb-16">
        <h1 className="mb-12 text-4xl text-center  font-bold">
          Customer <span className=" text-orange-500  ">Commit</span>
        </h1>
          ...
          <div className="hero p-2 md:p-0">
            <div className="hero-content flex-col lg:flex-row-reverse p-0">
              ...
              <div className="text-white ">
                <h1 className="m-5 text-3xl font-bold font-serif ">
                  YOU’LL BE HAPPY TO SEE OUR AWESOME
                </h1>
                <h1 className="m-5 text-3xl font-bold  font-serif ">
                  FEATURES.
                </h1>
