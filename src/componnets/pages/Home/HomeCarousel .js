          ...
          <div className="hero-content flex-col justify-between lg:flex-row  w-full">
            <div className="flex-1 w-full md:px-12 lg:px-0 text-left lg:pl-24 mb-16 lg:mb-0">
              <h1 className="text-6xl font-bold text-orange-500">
                Product <br /> Hand Tool <br /> 2022
              </h1>
              <p className="py-6">
                Exclusive email offers & Limited time discount <br /> specials
              </p>
              <button className="p-2 rounded bg-orange-500 hover:bg-zinc-800 hover:text-orange-500   text-white font-medium ">
                Get Started
              </button>
            </div>
