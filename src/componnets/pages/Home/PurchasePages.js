...
const PurchasePages = () => {
  ...
  return (
    <div className="px-5  md:px-20 my-10">
      <h1 className="text-center text-4xl font-bold text-secondary py-3 mb-10">
        Product Names : {name}
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 ">
        <div className="p-5 w-[80%] mx-auto shadow-xl rounded-2xl">
          ...
          <div className="flex justify-between">
            <h1 className="font-medium text-md text-secondary">
            ...
            <form onSubmit={Order}>
              <div className="md:flex items-center mt-12">
                <div className="md:w-[100%] flex flex-col">
                  ...
                  <input
                    ...
                    value={name}
                    disabled
                    className="text-base leading-none text-gray-900 p-3  focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100"
                    required
                  />
                  <label className="text-base  leading-none text-gray-800">
                    Email
                  ...
                  <input
                    ...
                    className="text-base leading-none text-gray-900 p-3  focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 "
                    required
                  />
                  <label className="text-base  leading-none text-gray-800">
                    Quantity
              ...
              <div className="flex items-center justify-center w-full">
                <input
                  type="submit"
                  value="SUBMIT"
                  className="mt-9 text-base  leading-none text-white py-4 px-10 bg-indigo-700 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none"
                />
              </div>
            </form>
          </div>
